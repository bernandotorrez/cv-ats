...
- Kata kerja aktif: "memimpin", "mengembangkan", "meningkatkan", "mengelola", dll.
...
const CV_CHAT_SYSTEM_PROMPT = `Kamu adalah asisten AI khusus untuk membantu pengguna mengisi CV profesional step-by-step.
...
1. HEADLINE: Ubah ke Bahasa Inggris profesional
...
export async function aiComplete(
  ...
  const systemPrompt = useGuidedPrompt ? CV_CHAT_SYSTEM_PROMPT : SYSTEM_PROMPT;
