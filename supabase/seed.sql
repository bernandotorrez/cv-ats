...
-- ============================================================
INSERT INTO public.subscription_tiers (slug, name, description, price_monthly, max_cvs, quota_ai_suggest, quota_ai_score, quota_ai_chat, quota_ai_cover_letter, quota_ai_keyword_extract, template_access, features, enable_cv_review, enable_cover_letter, enable_cv_comparison, enable_interview_simulator, enable_analytics, enable_linkedin_optimize, enable_text_polish, quota_ai_polish, sort_order) VALUES
  ...
  ('pro', 'Pro', 'Untuk profesional & career switcher yang ingin fitur lengkap.', 49000,
   ...
   '["CV Unlimited", "AI Saran Unlimited", "AI Scoring Unlimited", "Semua Template Premium", "AI Chat Unlimited", "Cover Letter Unlimited", "CV Review HR Expert", "Keyword Extractor", "CV Comparison", "Perbaiki Teks Unlimited", "Priority Support", "Export PDF & DOCX"]'::jsonb,
