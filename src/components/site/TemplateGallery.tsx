      ...
      <div className="container-page">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4 tracking-tight">
            {templatesData.length}+ Template <span className="text-green-700">ATS & Kreatif</span>{" "}
            Tersedia
          </h2>
          <p className="text-lg text-gray-600 mb-8">
            Template CV yang dirancang oleh ahli HR & recruiter — lolos screening sistem ATS, tetap
            terlihat profesional di mata manusia.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-12 text-sm md:text-base font-medium text-gray-700 mb-8">
            <div className="flex items-center gap-2">
              ...
              <span>
                Lolos ATS
                <br />
                <span className="text-gray-500 font-normal text-xs">(ATS-Optimized)</span>
              </span>
            </div>
            <div className="flex items-center gap-2">
              ...
              <span>
                Format Profesional
                <br />
                <span className="text-gray-500 font-normal text-xs">& Terstruktur</span>
              </span>
            </div>
            <div className="flex items-center gap-2">
              ...
              <span>
                Tampilan Menarik
                <br />
                <span className="text-gray-500 font-normal text-xs">di Mata Recruiter</span>
              </span>
            </div>
          </div>
