...
export const previewData = {
  ...
  malang: {
    personal: {
      ...
      headline: "Creative Director & Visual Designer",
      email: "anindya.larasati@designstudio.id",
      phone: "0857-1234-5678",
      location: "Malang, Jawa Timur",
      linkedin: "linkedin.com/in/anindyalarasati",
      website: "anindya.design",
      summary: "Creative director dengan pengalaman 6+ tahun di industri desain visual, branding, dan digital creative. Memimpin tim kreatif untuk brand nasional dan internasional dengan pendekatan design thinking yang strategis.",
      summaryAlign: "left" as const,
    },
    experiences: [
      {
        ...
        current: true,
        endDate: "",
        description: "Memimpin tim kreatif 8 orang. Mengarahkan visual identity untuk 30+ brand. Campaign desain meraih 3 penghargaan nasional. Revenue meningkat 45% melalui creative service baru.",
      },
      {
        id: "2",
        ...
        current: false,
        endDate: "Jan 2022",
        description: "Merancang visual campaign untuk seasonal sale dengan 50M+ impressions. Mendesain ulang brand guideline merchant page. Kolaborasi dengan tim product untuk UX improvement.",
      },
    ],
    educations: [
      {
        ...
        startDate: "2013",
        endDate: "2017",
        description: "Lulus Cum Laude, fokus pada branding dan interactive design",
      },
    ],
    skills: [
      { id: "1", name: "Adobe Creative Suite", level: "Expert" },
      { id: "2", name: "Figma & Sketch", level: "Advanced" },
      { id: "3", name: "Brand Identity", level: "Expert" },
      { id: "4", name: "Motion Graphics", level: "Intermediate" },
      { id: "5", name: "UI/UX Design", level: "Advanced" },
      { id: "6", name: "Design Thinking", level: "Expert" },
    ],
    languages: [
      { id: "1", name: "Bahasa Indonesia", level: "Native" },
      { id: "2", name: "English", level: "Advanced" },
    ...
    certificates: [
      { id: "1", name: "Adobe Certified Expert", issuer: "Adobe", date: "2023" },
      { id: "2", name: "Google UX Design", issuer: "Google", date: "2022" },
    ],
  } as CvData,
  ...
  solo: {
    personal: {
      ...
      email: "raka.aditya@techstudio.id",
      phone: "0812-3456-7890",
      location: "Solo, Jawa Tengah",
      linkedin: "linkedin.com/in/rakaaditya",
      website: "raka.dev",
      summary: "Tech lead dengan 7+ tahun pengalaman membangun aplikasi skala besar. Spesialisasi di React, Node.js, dan cloud infrastructure. Memimpin tim engineering 12 orang untuk produk SaaS dengan 100K+ pengguna aktif.",
      summaryAlign: "left" as const,
    },
    experiences: [
      {
        ...
        current: true,
        endDate: "",
        description: "Memimpin tim engineering 12 orang. Merancang arsitektur microservices untuk platform SaaS. Migrasi monolith ke microservices mengurangi downtime 80%. Implementasi CI/CD pipeline untuk 5 repositori.",
      },
      {
        id: "2",
        ...
        current: false,
        endDate: "Feb 2021",
        description: "Mengembangkan fitur payment gateway dengan 2M+ transaksi/hari. Optimasi query database mengurangi latency 60%. Mentoring 5 junior developer dalam best practices.",
      },
    ],
    educations: [
      {
        ...
        startDate: "2012",
        endDate: "2016",
        description: "Cum Laude, fokus pada distributed systems dan software engineering",
      },
    ],
    skills: [
      ...
      { id: "5", name: "AWS & Docker", level: "Advanced" },
  ...
  denpasar: {
    personal: {
      fullName: "Ayu Purnama Sari",
      headline: "Senior Content Strategist & Editor",
      email: "ayu.purnama@mediakarya.id",
      phone: "0858-9876-5432",
      location: "Denpasar, Bali",
      linkedin: "linkedin.com/in/ayupurnama",
      website: "ayuwrites.com",
      summary: "Content strategist dengan 8+ tahun di industri media dan penerbitan. Mengelola tim editorial 6 orang untuk platform konten dengan 500K+ pembaca bulanan. Ahli dalam SEO content, brand storytelling, dan editorial planning.",
      summaryAlign: "left" as const,
    },
    experiences: [
      {
        ...
        company: "Karya Media Group",
        location: "Denpasar",
        startDate: "Jan 2020",
        current: true,
        endDate: "",
        description: "Memimpin strategi konten untuk 3 platform digital. Meningkatkan organic traffic 120% melalui SEO content optimization. Mengelola budget editorial Rp 500 juta/tahun.",
      },
      {
        id: "2",
        ...
        current: false,
        endDate: "Dec 2019",
        description: "Mengedit 200+ artikel per bulan dengan standar editorial tinggi. Mengembangkan rubrik baru yang meningkatkan readership 35%. Melatih 8 staf junior dalam teknik penulisan.",
      },
    ],
    educations: [
      {
        ...
        school: "Universitas Udayana",
        degree: "S1",
        field: "Sastra Inggris",
        startDate: "2010",
        endDate: "2014",
        description: "Lulus dengan predikat Cum Laude, fokus pada creative writing dan linguistik",
      },
    ],
    skills: [
      { id: "1", name: "Content Strategy", level: "Expert" },
      { id: "2", name: "SEO Writing", level: "Expert" },
      { id: "3", name: "Brand Storytelling", level: "Advanced" },
      { id: "4", name: "Editorial Planning", level: "Expert" },
      { id: "5", name: "Copywriting", level: "Advanced" },
      { id: "6", name: "WordPress & CMS", level: "Advanced" },
    ],
    languages: [
      { id: "1", name: "Bahasa Indonesia", level: "Native" },
      { id: "2", name: "English", level: "Advanced" },
      { id: "3", name: "Bali", level: "Native" },
    ],
    certificates: [
      { id: "1", name: "HubSpot Content Marketing", issuer: "HubSpot", date: "2023" },
      { id: "2", name: "Google Analytics", issuer: "Google", date: "2022" },
    ],
  } as CvData,
  ...
  batu: {
    personal: {
      ...
      email: "dimas.prasetyo@designlab.id",
      phone: "0813-5678-1234",
      location: "Batu, Jawa Timur",
      linkedin: "linkedin.com/in/dimasprasetyo",
      website: "dimas.design",
      summary: "Product designer dengan 5+ tahun pengalaman di startup teknologi. Spesialisasi dalam design system, user research, dan prototyping. Telah mendesain produk untuk 15+ klien enterprise dengan pendekatan user-centered design.",
      summaryAlign: "left" as const,
    },
    experiences: [
      {
        ...
        company: "Startup Studio Indonesia",
        location: "Batu",
        startDate: "Apr 2022",
        current: true,
        endDate: "",
        description: "Memimpin tim desain 4 orang untuk portofolio 3 produk digital. Membangun design system yang digunakan 5 tim produk. Conduct user research untuk 20+ sesi usability testing.",
      },
      {
        id: "2",
        position: "UI/UX Designer",
        ...
        current: false,
        endDate: "Mar 2022",
        description: "Mendesain ulang checkout flow meningkatkan conversion rate 25%. Membuat komponen design system untuk 50+ halaman. Kolaborasi dengan 3 tim engineering untuk implementasi pixel-perfect.",
      },
    ],
    educations: [
      {
        ...
        startDate: "2014",
        endDate: "2018",
        description: "Fokus pada interaction design dan human-computer interaction",
      },
    ],
    skills: [
      { id: "1", name: "Figma & Design Systems", level: "Expert" },
      { id: "2", name: "User Research", level: "Advanced" },
      { id: "3", name: "Prototyping", level: "Expert" },
      { id: "4", name: "Interaction Design", level: "Advanced" },
      { id: "5", name: "HTML & CSS", level: "Intermediate" },
      { id: "6", name: "Design Thinking", level: "Expert" },
    ],
    languages: [
      { id: "1", name: "Bahasa Indonesia", level: "Native" },
    ...
    certificates: [
      { id: "1", name: "Google UX Design Professional", issuer: "Google", date: "2023" },
      { id: "2", name: "Interaction Design Foundation", issuer: "IxDF", date: "2022" },
    ],
  } as CvData,
};
...
export const templateMap = {
  ...
  solo: { name: "Solo", premium: true },
  denpasar: { name: "Denpasar", premium: true },
  batu: { name: "Batu", premium: true },
} as const;
