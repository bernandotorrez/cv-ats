    ...
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <Input
          ...
          disabled={loading}
        />
        <p className="text-xs text-muted-foreground">Contoh: https://linkedin.com/in/namakamu</p>
      </div>
      ...
      <div className="bg-primary/5 rounded-lg p-3 text-xs">
        <div className="flex items-start gap-2">
          ...
          <p className="text-muted-foreground">
            Data akan di-scrape langsung dari profil LinkedIn publik kamu. Nama, headline,
            pengalaman, pendidikan, skill, dan sertifikat akan otomatis terisi di editor CV.
          </p>
        </div>
      </div>
      ...
      <Button onClick={handleImport} disabled={loading || !url.trim()} className="w-full gap-2">
        {loading ? (
          <>
