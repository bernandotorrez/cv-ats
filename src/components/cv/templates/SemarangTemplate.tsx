...
export function SemarangTemplate({
  data,
  showHeader = true,
  sectionOrder,
  language = "id",
          ...
          return (
            <Section key="experience" title={t(language, "workExperience")}>
              {experiences.map((e) => (
                <div
                  key={e.id}
                  style={{ marginBottom: 10, paddingLeft: 8, borderLeft: "2px solid #059669" }}
                >
                  <div
                    style={{
                      display: "flex",
                  ...
                  <div
                    style={{ fontSize: "10pt", color: "#333", fontWeight: 500, marginBottom: 2 }}
                  >
                    {e.company}
                  </div>
                  {e.location && (
                    <div style={{ fontSize: "9pt", color: "#888", marginBottom: 3 }}>
                      {e.location}
                    </div>
                  )}
                  <p
            ...
            <Section key="internship" title={t(language, "internship")}>
              {internships.map((item) => (
                ...
                >
                  ...
                  >
                    <strong style={{ fontSize: "10.5pt", color: "#059669" }}>
                      {item.position}
                    </strong>
                    <span style={{ fontSize: "9pt", color: "#666" }}>
