...
export const Route = createFileRoute("/_authenticated/referral")({
  head: () =>
    buildSeo({
      title: "Program Referral — CV Pintar",
      description: "Ajak teman, dapatkan hadiah.",
      path: "/referral",
      noindex: true,
    }),
...
function ReferralPage() {
  ...
  const loadData = async () => {
    ...
    const { data: rpcCode, error: rpcErr } = await (supabase as any).rpc("generate_referral_code", {
    ...
    <div className="container-page py-10">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                ...
                <strong>dan upgrade ke paket berbayar</strong>, kamu dapat{" "}
                <strong>1 bulan Starter gratis</strong>. Berlaku kelipatan, tanpa batas!
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-6">
        {[
          ...
          {
            icon: TrendingUp,
            label: "Berhasil Upgrade",
            value: stats.successfulReferrals,
            color: "text-green-500",
          },
          {
            icon: Crown,
            label: "Reward Didapat",
            value: `${stats.rewardsEarned} bulan`,
            color: "text-warning",
          },
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <div className="flex gap-2">
              <Input
                value={stats.code}
                readOnly
                className="font-mono text-lg tracking-wider text-center bg-muted/50"
              />
          ...
          <div className="flex gap-2">
            <WhatsAppShare shareUrl={referralUrl} variant="default" size="sm" />
            <Button variant="outline" size="sm" onClick={copyLink}>
