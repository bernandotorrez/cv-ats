...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "CV Pintar — Buat CV ATS Friendly dengan AI" },
      { property: "og:description", content: "CV Pintar — Buat CV ATS Friendly dengan AI" },
      { name: "twitter:description", content: "CV Pintar — Buat CV ATS Friendly dengan AI" },
