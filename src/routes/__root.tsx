...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CV ATS Indonesia — Buat CV ATS Friendly dengan AI" },
      {
        name: "description",
        content:
      ...
      { property: "og:site_name", content: "CV ATS Indonesia" },
      { property: "og:locale", content: "id_ID" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "CV ATS Indonesia — Buat CV ATS Friendly dengan AI" },
      { name: "twitter:title", content: "CV ATS Indonesia — Buat CV ATS Friendly dengan AI" },
      { name: "description", content: "CV ATS Indonesia — Buat CV ATS Friendly dengan AI" },
      { property: "og:description", content: "CV ATS Indonesia — Buat CV ATS Friendly dengan AI" },
      { name: "twitter:description", content: "CV ATS Indonesia — Buat CV ATS Friendly dengan AI" },
