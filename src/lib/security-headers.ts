...
const CSP_DIRECTIVES = [
  ...
  "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://ai.sumopod.com https://*.hcaptcha.com https://analytics.google.com https://www.google-analytics.com https://*.google-analytics.com https://www.googletagmanager.com https://cloudflareinsights.com https://*.cloudflareinsights.com https://benixai.web.id https://www.benixai.web.id https://*.benixai.web.id wss://benixai.web.id wss://www.benixai.web.id wss://*.benixai.web.id",
